<template>
  <v-container class="custom-container">
    ...
    <v-row class="mt-10 mb-10">
      <v-textarea label="완성된 프로젝트 설명" variant="underlined" v-model="launchedProjectContents"></v-textarea>
    </v-row>
    ...
    <v-row justify="center" class="mt-15 ">
      ...
      <v-col cols="auto">
        <ButtonComponent content="취소" :style="{ color: '#650101', backgroundColor: '#FFAFAF'}"  class="ml-1" />
      </v-col>
      <v-col cols="auto">
  ...
  methods: {
    async registerLaunchedProject() {
      ...
      const body = {
        ...
        techStackList:techStackListJson,
